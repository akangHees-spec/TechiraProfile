...
<body class="font-sans antialiased bg-[#F8FAFC] text-[#0F172A]" x-data="{ sidebarOpen: false }">
    ...
    <aside x-bind:class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        class="fixed top-0 bottom-0 left-0 z-50 flex flex-col w-64 bg-primary text-white border-r border-slate-800 transition-transform duration-300 ease-in-out md:translate-x-0">
        <!-- Logo Header -->
    ...
    <div class="md:ml-64 flex flex-col min-h-screen">
        ...
        <!-- Sticky Topbar -->
        <header
            class="sticky top-0 z-20 flex items-center justify-between h-16 px-6 bg-white border-b border-slate-200 shadow-sm">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" @click.outside="open = false"
                        ...
                        <div
                            class="w-8 h-8 rounded-full bg-slate-200 border border-slate-300 flex items-center justify-center font-bold text-slate-700 uppercase text-xs">
